...
export function DigestReader({ digestId, onClose }: DigestReaderProps) {
  ...
  const header = (
    <div
      className="flex items-center justify-between px-4 md:px-5 py-3.5 shrink-0"
  ...
  const body = (
    <div className="flex-1 overflow-y-auto px-4 md:px-6 py-5">
      {isPending && (
        <div className="flex items-center justify-center h-32 text-xs" style={{ color: "var(--text-faint)" }}>
          Loading content…
        </div>
      )}
